<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="BanDienThoaiDiDong.Products" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="search-results-container">
        ...
        <div class="breadcrumb">
            ...
            <span class="current-page">Danh mục sản phẩm: "<asp:Label ID="lblSearchTerm" runat="server" />"</span>
        </div>
